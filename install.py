...
exec = sys.executable
print(f"Python executable: {exec}")
path = os.path.join(os.getcwd(), "main.py")
print(f"Script path: {path} WARNING: Do not move files anymore.")
cmd = f"{exec} {path}"
print(f"Running command: {cmd}")
print(f"Adding windows registery key..")
define_action_on("Directory", "GraphDirectory", f"{cmd} \"%1\"", title="Build graphs of this directory..")
print("[*] INSTALL SUCCESS ! ENJOY ;-)")
